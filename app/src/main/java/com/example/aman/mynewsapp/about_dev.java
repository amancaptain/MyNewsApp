package com.example.aman.mynewsapp;
        ...
        github.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* Intent myIntent = new Intent(v.getContext(), newsExplore.class);
                ...
                String url = "https://github.com/amancaptain";
        ...
        linkedin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* Intent myIntent = new Intent(v.getContext(), newsExplore.class);
                ...
                v.getContext().startActivity(myIntent);*/
                String url = "https://www.linkedin.com/in/aman-singh-4a6144179";
                Intent i = new Intent(Intent.ACTION_VIEW);
                i.setData(Uri.parse(url));
                startActivity(i);
            }
        ...
        stackoverflow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
             /*   Intent myIntent = new Intent(v.getContext(), newsExplore.class);
                ...
                v.getContext().startActivity(myIntent);*/
                String url = "https://stackoverflow.com/users/10846636/aman-singh";
                Intent i = new Intent(Intent.ACTION_VIEW);
                i.setData(Uri.parse(url));
                startActivity(i);
            }
